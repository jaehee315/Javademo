...
//		System.out.printf("var_default:%d%n", p.var_private);
//		System.out.printf("var_default:%d%n", p.var_default);
		System.out.printf("var_protected:%d%n", p.var_protected);
		System.out.printf("var_public:%d%n", p.var_public);
